...
(function() {
    Array.prototype.some || (Array.prototype.some = function(g, i) {
        var k = this.length;
    ...
    Array.prototype.forEach || (Array.prototype.forEach = function(g, i) {
        var k = this.length;
        if (typeof g != "function") throw new TypeError;
        for (var m = 0; m < k; m++) m in this && g.call(i, this[m], m, this)
    });
    Array.prototype.map || (Array.prototype.map = function(g, i) {
        var k = this.length;
        if (typeof g != "function") throw new TypeError;
        for (var m = Array(k), b = 0; b < k; b++) b in this && (m[b] = g.call(i, this[b], b, this));
        return m
    });
    Array.prototype.filter || (Array.prototype.filter = function(g, i) {
        var k = this.length;
        if (typeof g != "function") throw new TypeError;
        for (var m = [], b = 0; b < k; b++)
            if (b in this) {
    ...
    if (!Object.keys) {
        ...
        i.keys = function(i) {
            ...
            if (g)
                for (k = 0; k < z; k++) q.call(i, p[k]) && x.push(p[k]);
            return x
        }
    }
})();
...
(function() {
    function i() {
        ...
        this.addEdge = function(a, b, d, f) {
            ...
            if (!c.nodesIndex[d]) throw Error("Edge's target \"" +
        ...
        this.rescale = function(a, b, d, f) {
            ...
            var A = "outside" == c.p.scalingMode ?
                Math.max(a / Math.max(l - g, 1), b / Math.max(t - s, 1)) : Math.min(a / Math.max(l - g, 1), b / Math.max(t - s, 1)),
            ...
            var B, E;
            !c.p.maxEdgeSize && !c.p.minEdgeSize ? (B = 1, E = 0) : (B = c.p.maxEdgeSize == c.p.minEdgeSize ?
                0 : (c.p.maxEdgeSize - c.p.minEdgeSize) / j, E = c.p.minEdgeSize);
            d && c.nodes.forEach(function(c) {
        ...
        this.setBorders = function() {
            ...
            c.nodes.forEach(function(a) {
                ...
                c.borders.maxY = Math.max(void 0 == c.borders.maxY ? a.displayY - a.displaySize : c.borders.maxY,
    ...
    function q(b, j) {
        function f() {
            var a;
            a = "<p>GLOBAL :</p>";
            for (var b in c.p.globalProbes) a += "<p>" + b + " : " + c.p.globalProbes[b]() +
                "</p>";
            a += "<br><p>LOCAL :</p>";
    ...
    function g(b) {
        ...
        c.initMouseEvent(f, !0, !0, window, 1, j.posX, j.posY, j.clientX,
            j.clientY, !1, !1, !1, !1, 0, null);
    ...
    function p(b) {
        ...
        function c() {
            ...
            1 <= u && (window.clearInterval(a.interpolationID), b = a.ratio,
        ...
        b.addEventListener("mousedown", function(b) {
            a.p.mouseEnabled && (a.isMouseDown = !0, a.dispatch("mousedown"), w = a.stageX, o = a.stageY, i = a.mouseX, d = a.mouseY, t = s = a.stageX, k = A = a.stageY, a.dispatch("#startdrag"), b.preventDefault ? b.preventDefault() : b.returnValue = !1)
        }, !0);
        document.addEventListener("mouseup", function(b) {
            a.p.mouseEnabled && a.isMouseDown && (a.isMouseDown = !1, a.dispatch("mouseup"), 
    ...
    function z(b, j, f, c, a, g, d) {
        function i(a) {
            ...
            b.font = (h.p.hoverFontStyle || h.p.fontStyle || "") + " " + d + "px " + (h.p.hoverFont ||
                h.p.font || "");
            ...
            b.closePath();
            b.fill();
            b.fillStyle = "node" == h.p.labelHoverColor ? a.color || h.p.defaultNodeColor :
        ...
        this.drawActiveNode = function(a) {
            ...
            h.p.labelActiveShadow &&
                (b.shadowOffsetX = 0, b.shadowOffsetY = 0, b.shadowBlur = 4, b.shadowColor = h.p.labelActiveShadowColor);
            sigma.tools.drawRoundRect(b, Math.round(a.displayX - d / 2 - 2), Math.round(a.displayY - d / 2 - 2), Math.round(b.measureText(a.label).width + 1.5 * a.displaySize + d / 2 + 4), Math.round(d + 4), Math.round(d / 2 + 2), "left");
            b.closePath();
            b.fill();
            b.shadowOffsetX = 0;
            ...
            b.beginPath();
            b.fillStyle = "node" == h.p.nodeBorderColor ? a.color || h.p.defaultNodeColor : h.p.defaultNodeBorderColor;
            b.arc(Math.round(a.displayX),
                Math.round(a.displayY), a.displaySize + h.p.borderSize, 0, 2 * Math.PI, !0);
            b.closePath();
            b.fill();
            b.beginPath();
    ...
    function F(b, g) {
        ...
        function c(a, b) {
            ...
            d.domElements[a].setAttribute("height",
                d.height + "px");
        ...
        c("monitor", "div");
        c("mouse", "canvas");
        this.plotter = new z(this.domElements.nodes.getContext("2d"), this.domElements.edges.getContext("2d"), this.domElements.labels.getContext("2d"), this.domElements.hover.getContext("2d"),
            this.graph, this.width, this.height);
        ...
        this.draw = function(a, b, c, g) {
            if (g && sigma.chronos.getGeneratorsIDs().some(function(a) {
                    return !!a.match(RegExp("_ext_" + d.id + "$", ""))
                })) return d;
            ...
            d.graph.translate(d.mousecaptor.stageX,
                d.mousecaptor.stageY, d.mousecaptor.ratio, 0 < a, 0 < b);
            ...
            if (a)
                ...
                else sigma.chronos.addTask(d.plotter.task_drawNode, "node_" + d.id, !1), g = !0, j = "node_" +
                    d.id;
            if (c)
                if (1 < c)
    ...
    function x(b) {
        ...
        this.position = function(f, c, a) {
            ...
            b.mousecaptor.ratio = void 0 !=
                a ? a : b.mousecaptor.ratio;
            return j
        };
        ...
        this.zoomTo = function(f, c, a) {
            ...
            a == b.mousecaptor.ratio ? b.mousecaptor.interpolate(f - b.width / 2 + b.mousecaptor.stageX, c - b.height / 2 + b.mousecaptor.stageY) : b.mousecaptor.interpolate((a * f - b.mousecaptor.ratio * b.width / 2) / (a - b.mousecaptor.ratio), (a * c - b.mousecaptor.ratio * b.height / 2) / (a - b.mousecaptor.ratio), a);
            return j
        };
        this.resize =
            function(f, c) {
    ...
    sigma.chronos = new function() {
        ...
        function w() {
            Object.keys(r).length ? (h.dispatch("startgenerators"), h.unbind("killed", o), b(function() {
